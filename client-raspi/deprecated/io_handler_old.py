...
#inputs
btn_op = pfd.input_pins[0].value  #the state of the open button
btn_cl = pfd.input_pins[3].value  #the state of the close button
sns_op = pfd.input_pins[4].value  #the state of the open position sensor
sns_cl = pfd.input_pins[5].value  #the state of the closed position sensor
...
while True:
    ...
    #pause execution to reduce input check frequency
